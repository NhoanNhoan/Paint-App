...
namespace Drawing_Project.CustomComponents
{
    internal class Shape : Panel
    {
        ...
        {
            string nControlPoint = _nControlPoints.ToString();
            string startPosX = _startPos.X.ToString();
            string startPosY = _startPos.Y.ToString();
            string endPosX = _endPos.X.ToString();
            string endPosY = _endPos.Y.ToString();
            string penWidth = _pen.Width.ToString();
            string penColor = _pen.Color.ToString();
